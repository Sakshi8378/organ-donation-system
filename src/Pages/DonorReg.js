...
function DonorReg()
{
    ...
    <form className="mx-auto">
        ...
        <div className="form-group row">
            <label htmlFor="aliveStatus" className="col-sm-3 col-form-label">Is Donor Alive or Dead</label>
            <div className="col-sm-9">
                <div className="form-check">
                    <input className="form-check-input" type="radio" name="aliveStatus" id="alive" value="alive" />
                    <label className="form-check-label" htmlFor="alive">Alive</label>
                </div>
                <div className="form-check">
                    <input className="form-check-input" type="radio" name="aliveStatus" id="dead" value="dead" />
                    <label className="form-check-label" htmlFor="dead">Dead</label>
                </div>
            </div>
        </div>
        <div className="form-group row">
            <label htmlFor="deathCertificate" className="col-sm-3 col-form-label">Upload Death Certificate:</label>
            <div className="col-sm-9">
                <input type="file" className="form-control-file" id="deathCertificate" />
            </div>
        </div>
        <div className="form-group row">
